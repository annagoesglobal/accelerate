...
<div id="dpsp-feedback-form-wrapper" class="dpsp-inactive">
	...
	<div id="dpsp-feedback-form-inner">
		...
		<div id="dpsp-feedback-form-panel-2" class="dpsp-feedback-form-panel dpsp-todo">
			...
			<p id="dpsp-feedback-form-description-char-count-1" class="description"><?php echo __( 'Minimum 150 characters', 'social-pug' ); ?></p>
			<p id="dpsp-feedback-form-description-char-count-2" class="description"><?php echo sprintf( __( '%s characters remaining', 'social-pug' ), '<span id="dpsp-feedback-form-char-count">150</span>' ); ?></p>
